...
fun maze2 tape = let
    ...
    fun maze' steps idx = if idx > length - 1
                          ...
                          in
                              if current >= 3
                              then Array.update(tape, idx, current - 1)
                              else Array.update(tape, idx, current + 1);
